...
extension EditingTableView: UITableViewDataSource  {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0...2:
            ...
            switch indexPath.row {
            case 0:
                cell.configure(name: nameField, scrollEnabled: true, value: userModel.firstName)
            case 1:
                cell.configure(name: nameField, scrollEnabled: false, value: userModel.secondName)
            default:
